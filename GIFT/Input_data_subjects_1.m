...
icasso_opts.max_cluster_size = 30; % Max cluster size. Max is the no. of components
...
sourceDir_filePattern_flagLocation = {'C:\MATLAB6p5p2\work\Example Subjects\Visuomotor_data', 'nsr*.img', ...
        'data_in_subject_folder', (1:220)};
...
s1_s1 = {'C:\MATLAB6p5p2\work\Example Subjects\Visuomotor_data\sub01_vis', 'nsrstim*.img', (1:220)}; % subject 1 session 1

s2_s1 = {'C:\MATLAB6p5p2\work\Example Subjects\Visuomotor_data\sub02_vis', 'ns*.img', (1:220)}; % subject 2 session 1

s3_s1 = {'C:\MATLAB6p5p2\work\Example Subjects\Visuomotor_data\sub03_vis', 'nsr*.img', (1:220)}; % subject 3 session 1
...
input_directory_name = 'C:\MATLAB6p5p2\work\Example Subjects\Visuomotor_data';
...
input_data_file_patterns = {'C:\Users\Srinivas\mrn\data\visuomotor\sub01_vis\ns*img';
    'C:\Users\Srinivas\mrn\data\visuomotor\sub02_vis\ns*.img';
    'C:\Users\Srinivas\mrn\data\visuomotor\sub03_vis\ns*.img'};
...
outputDir = 'C:\Users\Srinivas\mrn\results\test_gift';
